...
const lblBattery = document.getElementById("battery");
...
clock.ontick = (e) => {
  ...
  // Change battery icon colour
  if (charge > 69){
    lblBattery.style.fill = "greenyellow";
    lblBattery.width = (charge / 5) + 1;
  } else if (charge > 24) {
    lblBattery.style.fill = "orange";
    lblBattery.width = (charge / 5) + 1;
  }else {
    lblBattery.style.fill = "#F81373";
    lblBattery.width = (charge / 5) + 1;
  }
